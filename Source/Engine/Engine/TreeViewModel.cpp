...
TreeViewModel::TreeViewModel() : ViewModel<TreeObstacle>(EntityType::TREE)
{
	/*
	...
	*/
	...
	orientRotateX(XM_PIDIV2);
	orientTranslate(0.0f, radius, width/2 - 0.25f);
}
...
bool TreeViewModel::InitializeVertexModels(ID3D11Device* d3dDevice){
...
bool TreeViewModel::InitializeTextures(TextureManager* texMan) 
{
	//bool result;
...
bool TreeViewModel::initializeTextures(ID3D11Device* d3dDevice){
...
bool TreeViewModel::RenderEntity(ID3D11DeviceContext* deviceContext,  XMFLOAT4X4 viewMatrix, XMFLOAT4X4 projectionMatrix, ColorShader* colorShader, TextureShader* textureShader, TreeObstacle* entity){
