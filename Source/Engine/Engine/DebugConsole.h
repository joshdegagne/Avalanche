...
static void writeLabelToConsole(const wchar_t* theString, int i)
{
	writeTextToConsole(theString);
	writeNumToConsole(i);
	writeTextToConsole(L"\n");
}
static void writeLabelToConsole(const wchar_t* theString, float f)
{
	writeTextToConsole(theString);
	writeNumToConsole(f);
	writeTextToConsole(L"\n");
